...
public class FirebombModel extends Model<Unit> {
    private final ModelPart firebomb;

    public FirebombModel(ModelPart root) {
        super(root.getChild("firebomb"), RenderTypes::entityCutout);
        this.firebomb = root.getChild("firebomb");
    }
