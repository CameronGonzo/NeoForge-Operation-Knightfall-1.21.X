...
public class FlechetteRenderer extends EntityRenderer<FlechetteEntity> {
    ...
    private static final ResourceLocation FLECHETTE_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(OperationKnightfall.MODID, "textures/entity/flechette.png");
    ...
    @Override
    public void render(FlechetteEntity entity, float entityYaw, float partialTicks, PoseStack poseStack,
        ...
        VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.entitySolid(FLECHETTE_TEXTURE));
    ...
    @Override
    public ResourceLocation getTextureLocation(FlechetteEntity entity) {
