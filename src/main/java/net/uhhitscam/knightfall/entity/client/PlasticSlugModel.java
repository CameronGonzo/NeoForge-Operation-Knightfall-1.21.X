...
public class PlasticSlugModel extends HierarchicalModel<PlasticSlugEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition plasticSlug = partdefinition.addOrReplaceChild("plasticSlug", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -6.0F, -2.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.001F))
