...
public class RazorSteelSlugModel extends HierarchicalModel<RazorSteelSlugEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition razorSteelSlug = partdefinition.addOrReplaceChild("razorSteelSlug", CubeListBuilder.create().texOffs(8, 4).addBox(-1.0F, -6.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F))
