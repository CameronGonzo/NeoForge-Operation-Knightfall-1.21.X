...
public class SigBlasterBoltRenderer extends EntityRenderer<SigBlasterBoltEntity> {
    ...
    private static final ResourceLocation GLOW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(OperationKnightfall.MODID, "textures/entity/sig_bolt_exterior.png");
    ...
    @Override
    public void render(SigBlasterBoltEntity entity, float entityYaw, float partialTicks, PoseStack poseStack,
