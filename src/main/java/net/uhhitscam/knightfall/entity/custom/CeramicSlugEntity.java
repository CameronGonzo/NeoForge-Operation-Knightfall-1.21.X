...
public class CeramicSlugEntity extends Snowball {
    ...
    public CeramicSlugEntity(EntityType<? extends CeramicSlugEntity> entityType, Level level) {
    ...
    public CeramicSlugEntity(EntityType<? extends CeramicSlugEntity> entityType, Level level, LivingEntity shooter, float slugSpeed, int slugDamage, WeaponClassification classification) {
        super(entityType, level);
    ...
    protected Item getDefaultItem() {
        return ModItems.CERAMIC_SLUG.get();
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        int i = -1;
        int ceramicSlugDamage = i + slugDamage;

        if (net.uhhitscam.knightfall.util.WeaponDamage.hurt(entity, this.damageSources().thrown(this, this.getOwner()), ceramicSlugDamage)) {
