...
public class FlechetteToxicEntity extends Snowball {
    private final float flechetteSpeed;
    private final int flechetteDamage;
    private final int lifeSpan;

    public FlechetteToxicEntity(EntityType<? extends FlechetteToxicEntity> entityType, Level level) {
    ...
    public FlechetteToxicEntity(EntityType<? extends FlechetteToxicEntity> entityType, Level level, LivingEntity shooter, float flechetteSpeed, int flechetteDamage, int lifeSpan) {
        super(entityType, level);
    ...
    protected Item getDefaultItem() {
        return ModItems.FLECHETTE_TOXIC.get();
    }
