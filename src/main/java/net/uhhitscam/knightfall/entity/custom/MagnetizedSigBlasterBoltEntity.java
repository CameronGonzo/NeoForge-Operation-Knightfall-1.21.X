...
public class MagnetizedSigBlasterBoltEntity extends Snowball {
    ...
    public MagnetizedSigBlasterBoltEntity(EntityType<? extends MagnetizedSigBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, WeaponClassification classification, boolean explosiveShot) {
    ...
    private void explode(Vec3 hitPos) {
        if (!level().isClientSide) {
            double radius = 2.0D; // explosion radius
