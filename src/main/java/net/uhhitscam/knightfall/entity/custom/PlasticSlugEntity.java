...
public class PlasticSlugEntity extends Snowball {
    private final float slugSpeed;
    private final int slugDamage;
    private final WeaponClassification classification;

    public PlasticSlugEntity(EntityType<? extends PlasticSlugEntity> entityType, Level level) {
    ...
    public PlasticSlugEntity(EntityType<? extends PlasticSlugEntity> entityType, Level level, LivingEntity shooter, float slugSpeed, int slugDamage, WeaponClassification classification) {
        super(entityType, level);
    ...
    protected Item getDefaultItem() {
        return ModItems.PLASTIC_SLUG.get();
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        int i = -3;
        int plasticSlugDamage = i + slugDamage;

        if (net.uhhitscam.knightfall.util.WeaponDamage.hurt(entity, this.damageSources().thrown(this, this.getOwner()), plasticSlugDamage)) {
