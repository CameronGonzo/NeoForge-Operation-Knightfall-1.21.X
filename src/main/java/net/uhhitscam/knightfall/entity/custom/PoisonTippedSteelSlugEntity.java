...
public class PoisonTippedSteelSlugEntity extends Snowball {
    ...
    public PoisonTippedSteelSlugEntity(EntityType<? extends PoisonTippedSteelSlugEntity> entityType, Level level) {
    ...
    public PoisonTippedSteelSlugEntity(EntityType<? extends PoisonTippedSteelSlugEntity> entityType, Level level, LivingEntity shooter, float slugSpeed, int slugDamage, WeaponClassification classification, WeaponName weaponName) {
        super(entityType, level);
    ...
    protected Item getDefaultItem() {
        return ModItems.POISON_TIPPED_STEEL_SLUG.get();
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        int i = 0;
        int poisonTippedSteelSlugDamage = i + slugDamage;

        if (net.uhhitscam.knightfall.util.WeaponDamage.hurt(entity, this.damageSources().thrown(this, this.getOwner()), poisonTippedSteelSlugDamage)) {
