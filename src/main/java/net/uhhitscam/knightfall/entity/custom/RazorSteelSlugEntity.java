...
public class RazorSteelSlugEntity extends Snowball {
    ...
    public RazorSteelSlugEntity(EntityType<? extends RazorSteelSlugEntity> entityType, Level level) {
    ...
    public RazorSteelSlugEntity(EntityType<? extends RazorSteelSlugEntity> entityType, Level level, LivingEntity shooter, float slugSpeed, int slugDamage, WeaponClassification classification, WeaponName weaponName) {
        super(entityType, level);
    ...
    protected Item getDefaultItem() {
        return ModItems.RAZOR_STEEL_SLUG.get();
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        int i = 1;
        int razorSteelSlugDamage = i + slugDamage;

        if (net.uhhitscam.knightfall.util.WeaponDamage.hurt(entity, this.damageSources().thrown(this, this.getOwner()), razorSteelSlugDamage)) {
