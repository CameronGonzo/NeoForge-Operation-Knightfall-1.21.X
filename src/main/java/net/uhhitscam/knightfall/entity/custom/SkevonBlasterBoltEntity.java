...
public class SkevonBlasterBoltEntity extends Snowball {
    ...
    public SkevonBlasterBoltEntity(EntityType<? extends SkevonBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, WeaponClassification classification, WeaponName weaponName, boolean explosiveShot, boolean concussiveShot) {
        super(entityType, level);
