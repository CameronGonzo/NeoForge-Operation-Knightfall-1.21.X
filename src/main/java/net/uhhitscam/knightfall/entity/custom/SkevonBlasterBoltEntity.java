...
public class SkevonBlasterBoltEntity extends Snowball {
    ...
    public SkevonBlasterBoltEntity(EntityType<? extends SkevonBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, WeaponClassification classification, boolean explosiveShot, boolean concussiveShot) {
