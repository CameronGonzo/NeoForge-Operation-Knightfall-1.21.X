...
public class SpinSealedTibannaBlasterBoltEntity extends Snowball {
    ...
    public SpinSealedTibannaBlasterBoltEntity(EntityType<? extends SpinSealedTibannaBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, WeaponClassification classification, boolean explosiveShot) {
    ...
    protected void onHit(HitResult result) {
        ...
        if (!this.level().isClientSide) {
            ...
            if (this.level() instanceof ServerLevel serverLevel) {
                if (explosiveShot) {
                    serverLevel.sendParticles(ModParticles.EXPLOSIVE_SHOT_SPIN_SEALED_TIBANNA_PARTICLES.get(),
