...
public class TibannaXBlasterBoltEntity extends Snowball {
    ...
    public TibannaXBlasterBoltEntity(EntityType<? extends TibannaXBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, WeaponClassification classification, boolean explosiveShot) {
