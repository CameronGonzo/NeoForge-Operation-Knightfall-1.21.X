...
public class ExplosiveShotTibannaParticles extends TextureSheetParticle {
    private final SpriteSet sprites;
    private static final int FRAME_COUNT = 4;
    private static final int FRAME_DURATION_TICKS = 1;

    protected ExplosiveShotTibannaParticles(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new ExplosiveShotTibannaParticles(level, x, y, z, this.spriteSet, xSpeed, ySpeed, zSpeed);
        }
    }
}
