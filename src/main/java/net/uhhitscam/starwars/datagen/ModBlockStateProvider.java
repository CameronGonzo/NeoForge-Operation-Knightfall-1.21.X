...
//        blockItem(ModBlocks.BLACK_OPAL_TRAPDOOR, "_bottom");
    ...
    private void blockItem(DeferredBlock<Block> deferredBlock) {
        simpleBlockItem(deferredBlock.get(), new ModelFile.UncheckedModelFile("starwars:block/" + deferredBlock.getId().getPath()));
    }

    private void blockItem(DeferredBlock<Block> deferredBlock, String appendix) {
        simpleBlockItem(deferredBlock.get(), new ModelFile.UncheckedModelFile("starwars:block/" + deferredBlock.getId().getPath() + appendix));
    }
}
