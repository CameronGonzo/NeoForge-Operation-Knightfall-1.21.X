...
public class MagnetizedSigBlasterBoltModel extends HierarchicalModel<MagnetizedSigBlasterBoltEntity> {
    private final ModelPart magnetizedsigblasterbolt;

    public MagnetizedSigBlasterBoltModel(ModelPart root) {
        this.magnetizedsigblasterbolt = root.getChild("magnetized_sig_blaster_bolt");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition magnetized_sig_blaster_bolt = partdefinition.addOrReplaceChild("magnetized_sig_blaster_bolt", CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, -0.75F, 0.0F, 30.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        magnetizedsigblasterbolt.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }

    @Override
    public ModelPart root() {
        return magnetizedsigblasterbolt;
    }
}
