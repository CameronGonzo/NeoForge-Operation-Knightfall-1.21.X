...
public class SigBlasterBoltModel extends HierarchicalModel<SigBlasterBoltEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition sig_blaster_bolt = partdefinition.addOrReplaceChild("sig_blaster_bolt", CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, -0.75F, 0.0F, 30.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
    ...
    @Override
    public void setupAnim(SigBlasterBoltEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
