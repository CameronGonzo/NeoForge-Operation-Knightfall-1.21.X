...
public class SigBlasterBoltRenderer extends EntityRenderer<SigBlasterBoltEntity> {
    private SigBlasterBoltModel model;

    public SigBlasterBoltRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SigBlasterBoltModel(context.bakeLayer(ModModelLayers.SIG_BLASTER_BOLT));
    }

    @Override
    public void render(SigBlasterBoltEntity pEntity, float entityYaw, float partialTicks, PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(SigBlasterBoltEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(OperationKnightfall.MODID, "textures/entity/sig_blaster_bolt.png");
    }
}