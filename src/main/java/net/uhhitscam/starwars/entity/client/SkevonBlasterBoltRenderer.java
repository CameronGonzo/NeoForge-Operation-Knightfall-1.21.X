...
public class SkevonBlasterBoltRenderer extends EntityRenderer<SkevonBlasterBoltEntity> {
    ...
    private static final ResourceLocation GLOW_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(OperationKnightfall.MODID, "textures/entity/skevon_bolt_exterior.png");
    ...
    @Override
    public void render(SkevonBlasterBoltEntity entity, float entityYaw, float partialTicks, PoseStack poseStack,
