...
public class SpinSealedTibannaBlasterBoltModel extends HierarchicalModel<SpinSealedTibannaBlasterBoltEntity> {
    private final ModelPart spinsealedtibannablasterbolt;

    public SpinSealedTibannaBlasterBoltModel(ModelPart root) {
        this.spinsealedtibannablasterbolt = root.getChild("spin_sealed_tibanna_blaster_bolt");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition spin_sealed_tibanna_blaster_bolt = partdefinition.addOrReplaceChild("spin_sealed_tibanna_blaster_bolt", CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, -0.75F, 0.0F, 30.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
    ...
    @Override
    public void setupAnim(SpinSealedTibannaBlasterBoltEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {

    }

    @Override
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        spinsealedtibannablasterbolt.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }

    @Override
    public ModelPart root() {
        return spinsealedtibannablasterbolt;
    }
}
