...
public class SpinSealedTibannaBlasterBoltRenderer extends EntityRenderer<SpinSealedTibannaBlasterBoltEntity> {
    ...
    @Override
    public void render(SpinSealedTibannaBlasterBoltEntity pEntity, float entityYaw, float partialTicks, PoseStack poseStack,
    ...
    public ResourceLocation getTextureLocation(SpinSealedTibannaBlasterBoltEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(OperationKnightfall.MODID, "textures/entity/spin_sealed_tibanna_blaster_bolt.png");
    }
}