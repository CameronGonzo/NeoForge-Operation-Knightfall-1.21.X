...
public class TibannaBlasterBoltModel extends HierarchicalModel<TibannaBlasterBoltEntity> {
    private final ModelPart tibannablasterbolt;

    public TibannaBlasterBoltModel(ModelPart root) {
        this.tibannablasterbolt = root.getChild("tibanna_blaster_bolt");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition tibanna_blaster_bolt = partdefinition.addOrReplaceChild("tibanna_blaster_bolt", CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, -0.75F, 0.0F, 30.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        tibannablasterbolt.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }

    @Override
    public ModelPart root() {
        return tibannablasterbolt;
    }
}
