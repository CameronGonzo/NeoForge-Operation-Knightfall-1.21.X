...
public class MagnetizedSigBlasterBoltEntity extends Snowball {
    private final float bolt_speed;
    private final int blasterDamage;
    private final String currentGasType;
    private final String classification;

    public MagnetizedSigBlasterBoltEntity(EntityType<? extends MagnetizedSigBlasterBoltEntity> entityType, Level level) {
        super(entityType, level);
        //base values just in case something goes wrong
        this.bolt_speed = 2.0F;
        this.blasterDamage = 0;
        this.currentGasType = "MAGNETIZED_SIG_GAS";
        this.classification = "PISTOL";
    }

    public MagnetizedSigBlasterBoltEntity(EntityType<? extends MagnetizedSigBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, String currentGasType, String classification) {
        super(ModEntities.MAGNETIZED_SIG_BLASTER_BOLT.get(), level); // Directly reference the EntityType
    ...
    protected Item getDefaultItem() {
        return ModItems.MAGNETIZED_SIG_BLASTER_BOLT.get();
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        int i =  3; //purple is very rare and hard to get
