...
public class MagnetizedSigBlasterBoltEntity extends Snowball {
    ...
    public MagnetizedSigBlasterBoltEntity(EntityType<? extends MagnetizedSigBlasterBoltEntity> entityType, Level level) {
        ...
        this.currentGasType = GasType.MAGNETIZED_SIG;
        this.classification = Classification.PISTOL;
    }

    public MagnetizedSigBlasterBoltEntity(EntityType<? extends MagnetizedSigBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, GasType currentGasType, Classification classification) {
