...
public class SkevonBlasterBoltEntity extends Snowball {
    ...
    public SkevonBlasterBoltEntity(EntityType<? extends SkevonBlasterBoltEntity> entityType, Level level) {
        ...
        this.currentGasType = "SKEVON_GAS";
        this.classification = "PISTOL";
    }

    public SkevonBlasterBoltEntity(EntityType<? extends SkevonBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, String currentGasType, String classification) {
        super(ModEntities.SKEVON_BLASTER_BOLT.get(), level); // Directly reference the EntityType
    ...
    protected Item getDefaultItem() {
        return ModItems.SKEVON_BLASTER_BOLT.get();
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        int i = (-1 * blasterDamage) + 1; //training blaster bolts are skevon
