...
public class SkevonBlasterBoltEntity extends Snowball {
    ...
    public SkevonBlasterBoltEntity(EntityType<? extends SkevonBlasterBoltEntity> entityType, Level level) {
        ...
        this.currentGasType = GasType.SKEVON;
        this.classification = Classification.PISTOL;
    }

    public SkevonBlasterBoltEntity(EntityType<? extends SkevonBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, GasType currentGasType, Classification classification) {
