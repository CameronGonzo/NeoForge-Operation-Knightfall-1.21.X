...
public class SpinSealedTibannaBlasterBoltEntity extends Snowball {
    ...
    public SpinSealedTibannaBlasterBoltEntity(EntityType<? extends SpinSealedTibannaBlasterBoltEntity> entityType, Level level) {
        ...
        this.currentGasType = GasType.SPIN_SEALED_TIBANNA;
        this.classification = Classification.PISTOL;
    }

    public SpinSealedTibannaBlasterBoltEntity(EntityType<? extends SpinSealedTibannaBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, GasType currentGasType, Classification classification) {
