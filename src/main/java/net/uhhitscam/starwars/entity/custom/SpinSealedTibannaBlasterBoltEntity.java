...
public class SpinSealedTibannaBlasterBoltEntity extends Snowball {
    ...
    public SpinSealedTibannaBlasterBoltEntity(EntityType<? extends SpinSealedTibannaBlasterBoltEntity> entityType, Level level) {
        ...
        this.currentGasType = "SPIN_SEALED_TIBANNA_GAS";
        this.classification = "PISTOL";
    }

    public SpinSealedTibannaBlasterBoltEntity(EntityType<? extends SpinSealedTibannaBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, String currentGasType, String classification) {
        super(ModEntities.SPIN_SEALED_TIBANNA_BLASTER_BOLT.get(), level); // Directly reference the EntityType
    ...
    protected Item getDefaultItem() {
        return ModItems.SPIN_SEALED_TIBANNA_BLASTER_BOLT.get();
    }
