...
public class TibannaBlasterBoltEntity extends Snowball {
    ...
    public TibannaBlasterBoltEntity(EntityType<? extends TibannaBlasterBoltEntity> entityType, Level level) {
        ...
        this.currentGasType = GasType.TIBANNA;
        this.classification = Classification.PISTOL;
    }

    public TibannaBlasterBoltEntity(EntityType<? extends TibannaBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, GasType currentGasType, Classification classification) {
    ...
    protected Item getDefaultItem() {
        return ModItems.TIBANNA_BLASTER_BOLT.get();
    }
