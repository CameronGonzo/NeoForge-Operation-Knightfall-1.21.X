...
public class TibannaXBlasterBoltEntity extends Snowball {
    private final float bolt_speed;
    private final int blasterDamage;
    private final String currentGasType;
    private final String classification;

    public TibannaXBlasterBoltEntity(EntityType<? extends TibannaXBlasterBoltEntity> entityType, Level level) {
        super(entityType, level);
        //base values just in case something goes wrong
        this.bolt_speed = 2.0F;
        this.blasterDamage = 0;
        this.currentGasType = "TIBANNAX_GAS";
        this.classification = "PISTOL";
    }

    public TibannaXBlasterBoltEntity(EntityType<? extends TibannaXBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, String currentGasType, String classification) {
        super(ModEntities.TIBANNAX_BLASTER_BOLT.get(), level); // Directly reference the EntityType
    ...
    protected Item getDefaultItem() {
        return ModItems.TIBANNAX_BLASTER_BOLT.get();
    }
    ...
    protected void onHitEntity(EntityHitResult result) {
        ...
        int i = 0; //TibannaX gas does no additional damage
