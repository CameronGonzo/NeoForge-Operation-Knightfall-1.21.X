...
public class TibannaXBlasterBoltEntity extends Snowball {
    ...
    public TibannaXBlasterBoltEntity(EntityType<? extends TibannaXBlasterBoltEntity> entityType, Level level) {
        ...
        this.currentGasType = GasType.TIBANNAX;
        this.classification = Classification.PISTOL;
    }

    public TibannaXBlasterBoltEntity(EntityType<? extends TibannaXBlasterBoltEntity> entityType, Level level, LivingEntity shooter, float bolt_speed, int blasterDamage, GasType currentGasType, Classification classification) {
