...
public class BlasterSoundsUtil {
    public static SoundEvent getBlasterFireSound(String blasterName, Boolean stunFiring) {
        if (stunFiring) {
        ...
        return switch (blasterName) {
            ...
            case "a180" -> ModSounds.A180_FIRE.get();
            case "a280" -> ModSounds.A280_FIRE.get();
            case "a280c" -> ModSounds.A280C_FIRE.get();
            case "a280cfe" -> ModSounds.A280CFE_FIRE.get();
            ...
            case "blndrbus" -> ModSounds.BLNDRBUS_FIRE.get();
            ...
            case "bowcaster" -> ModSounds.BOWCASTER_FIRE.get();
            case "br14" -> ModSounds.BR14_FIRE.get();
            case "bryar_rifle" -> ModSounds.BRYAR_RIFLE_FIRE.get();
            ...
            case "ca87" -> ModSounds.CA87_FIRE.get();
            case "caij_vandas_blaster_pistol" -> ModSounds.CAIJ_VANDAS_BLASTER_PISTOL_FIRE.get();
            ...
            case "dc17m" -> ModSounds.DC17M_FIRE.get();
            ...
            case "dl44" -> ModSounds.DL44_FIRE.get();
            ...
            case "dlt20a" -> ModSounds.DLT20A_FIRE.get();
            ...
            case "ewhb12" -> ModSounds.EWHB12_FIRE.get();
            ...
            case "k16_bryar_pistol" -> ModSounds.K16_BRYAR_PISTOL_FIRE.get();
            ...
            case "motto_mk_4" -> ModSounds.MOTTO_MK_4_FIRE.get();
            ...
            case "relby_v10" -> ModSounds.RELBY_V10_FIRE.get();
            ...
            case "shadow_trooper_blaster" -> ModSounds.SHADOW_TROOPER_BLASTER_FIRE.get();
    ...
    public static SoundEvent getBlasterReloadSound(String blasterName) {
        return switch (blasterName) {
            case "amban_disruptor" -> ModSounds.FOLEY_AMBAN_DISRUPTOR_SNIPER_RIFLE_RELOAD.get();
            case "v6d_mortar_launcher", "mortar", "k21c_portable_ordanance_launcher" -> ModSounds.FOLEY_LARGE_LAUNCHER_RELOAD.get();
            case "lightbow", "vulk_tau623_rotary", "z6_rotary", "eweb", "ewhb12", "m32", "m45", "m55", "m61", "mwc35c", "t21", "t21b",
                 "bm107", "galar90", "nt242", "ge36", "neo_crusader_rifle", "boiler_rifle", "bowcaster", "t7_ion_diruptor" -> ModSounds.FOLEY_LARGE_RELOAD_GAS.get();
            case "a140", "a180", "ac177", "apache", "astra40", "b22", "be09", "bh4", "blurrg1120",
                 ...
                 "nambu14", "p38", "pcc_projector", "premier", "q2", "relby_k23", "renegade", "rg4d", "rk3",
                 ...
                 "x8_night_sniper", "panic_pistol", "verpine_shatter" -> ModSounds.FOLEY_SMALL_RELOAD_GAS.get();
            default -> ModSounds.FOLEY_MEDIUM_RELOAD_GAS.get();
        };
    }

    public static SoundEvent getBlasterSwitchFireMode(String blasterName) {
        return switch (blasterName) {
            case "amban_disruptor" -> ModSounds.FOLEY_AMBAN_DISRUPTOR_SNIPER_RIFLE_SWITCH_FIRE_MODE.get();
            case "b1na" -> ModSounds.FOLEY_B1NA_SWITCH_FIRE_MODE.get();
            case "mw20_bryar_pistol" -> ModSounds.FOLEY_MW20_BRYAR_PISTOL_SWITCH_FIRE_MODE.get();
            case "bt_x42_flamethrower", "k21c_portable_ordanance_launcher", "lightbow", "minimag_proton_torpedo_launcher",
                 ...
                 "bm107", "galar90" -> ModSounds.FOLEY_LARGE_SWITCH_FIRE_MODE.get();
            case "_434_deathhammer", "a140", "a180", "ac177", "apache", "astra40", "b22", "be09", "bh4", "blurrg1120",
                 ...
                 "ec17", "elg3a", "flintloq_pistol", "fn57", "fp45", "gl77", "hf94", "ib94", "k16_bryar_pistol", "koch9s",
                 "krie4", "kueget_ln21", "kyd21", "leucht42", "ll30", "lug_po8", "lw896", "m19a1", "marg_mcm", "model_57",
                 "nambu14", "p38", "pcc_projector", "power_5", "premier", "q2", "relby_k23", "renegade", "rg4d", "rk3",
                 "rskf44", "ruger", "s195", "s5", "sacros_k11", "satines_lament", "sc_x30", "se14c", "serexim_mk_5",
                 "sedgleys_mk_5", "shard3a", "sk32", "snubble", "steyr43", "t6", "tca_pro", "type14", "umbaran_pistol",
                 "walther_blaster", "walther_lpm_blaster", "webly_s4", "webtemp", "weequay_pistol", "westar_20", "westar_34",
                 "westar_35", "x8_night_sniper", "panic_pistol", "verpine_shatter" -> ModSounds.FOLEY_SMALL_SWITCH_FIRE_MODE.get();
            default -> ModSounds.FOLEY_MEDIUM_SWITCH_FIRE_MODE.get();
        };
    }
